            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div>
                    ...
                    <p className="mt-2 max-w-3xl text-sm leading-6 text-ink-soft">
                        交易叙事、最新事件撤销和现金调整都写入审计记录；持仓事件（PositionEvent）是复盘叙事的权威来源，旧版批次编辑仅用于数据迁移。
                    </p>
                </div>
                <div className="flex flex-col gap-2 sm:flex-row">
                    ...
                    <button type="button" onClick={onManualAdjustment} disabled={!actions.cashAdjustment.canRun} title={actions.cashAdjustment.reason} className="inline-flex items-center justify-center gap-2 rounded-md border border-line bg-panel-subtle px-4 py-2 text-sm font-medium text-ink-soft transition-colors hover:bg-panel">
