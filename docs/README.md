...
| [trade-record-sync-design.md](./trade-record-sync-design.md) | 通用 bootstrap、IBKR Flex source-bound 文件增量导入与 correction replay 设计；JRN-013 内部实现尚受 provider evidence 阻断，JRN-014/015 未实现，在线 sync 延期。 |
| [superpowers/plans/2026-07-26-jrn-013-progress-review.md](./superpowers/plans/2026-07-26-jrn-013-progress-review.md) | JRN-013 当前实现、外部证据阻断、设计必要性与后续开发顺序评审。 |
