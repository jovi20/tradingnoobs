...
- [ ] 更新 `DEVELOPER_GUIDE.md`，让技术栈、首页形态、数据模型、schema 初始化、已落地能力与 `dev` 一致。
- [ ] 更新 `docs/README.md`，补上当前计划、checkpoint、P9/P10 文档入口。
- [ ] 更新 sequencing plan，把 P9A-P9F 已完成事项从“待做”转为真实状态。
- [ ] 新增 P10 开发计划文档，明确 hard cutover、observability、legacy 清理、后续功能 backlog 的执行顺序。
