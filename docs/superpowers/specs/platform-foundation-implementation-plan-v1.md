...
- 已具备 asset/timeframe、broker connection、content source、AI scope 等资源锁的通用承载方式；尚未把所有业务入口系统性写入对应 `business_locks` payload，也尚未接入 Redis worker 与最终 derived timeline materialization。
