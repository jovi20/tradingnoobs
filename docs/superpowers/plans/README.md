...
| 文档 | 用途 |
|------|------|
| [2026-07-16-dev-trading-journal-development-plan.md](./2026-07-16-dev-trading-journal-development-plan.md) | 当前唯一 active implementation plan；交易日志 launch-safe Beta 的范围、任务顺序和验收门。 |
...
- 新计划只有在明确要进入新阶段时才加入此目录。
- 已完成的阶段计划移入 [archive/](./archive/)，不要继续显示为 active lane。
- 当前执行清单维护在 [../../TODO.md](../../TODO.md)。
- 项目描述和后续路线图维护在 [../../project-summary-and-roadmap.md](../../project-summary-and-roadmap.md)。
