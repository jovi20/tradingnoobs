...
- D4 admin job read API can list jobs by status/queue and read a job detail with definition, payload, result, error, timing/lock fields, and event history.
