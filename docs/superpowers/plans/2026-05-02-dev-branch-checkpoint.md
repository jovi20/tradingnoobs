...
- D1 unified job model and D2 outbox event schema have migration/model regressions; transactional outbox writes, relay, Redis worker, and D3 idempotent execution rules remain pending.
