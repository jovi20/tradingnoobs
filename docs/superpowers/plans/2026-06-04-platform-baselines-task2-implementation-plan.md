...
- [ ] **Step 2: Create a minimal failing identity test**
...
- [ ] **Step 4: Implement minimal identity helpers**
...
- [ ] **Step 5: Remove runtime schema creation**
...
- [ ] **Step 1: Write failing auth identity tests**
...
def test_user_response_exposes_public_id_not_only_integer_id(client):
    ...


def test_current_user_accepts_public_id_subject_and_legacy_integer_subject(db_session):
    ...
```

- [ ] **Step 2: Run auth identity tests and verify RED**
...
- [ ] **Step 3: Add identity fields and auth support models**
...
- [ ] **Step 4: Update auth service and schemas**
...
- [ ] **Step 3: Add observability helpers and dependency**
...
- [ ] **Step 5: Run observability tests and verify GREEN**
